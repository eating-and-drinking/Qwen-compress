...
Three composable stages 鈥?**MOT-FD Distillation 鈫?SparseGPT Pruning 鈫?INT8 QAT/QAD** 鈥?that take a 14B-class teacher down to a 3B INT8 student suitable for edge deployment, while preserving chain-of-thought reasoning quality.
...
- **Channel permutation for 2:4** (`prune.permutation.enabled: true`). Prune unstructured for max accuracy, then search a column permutation that snaps the existing zeros onto a 2:4 grid, then hard-enforce the residual. Yields ~unstructured accuracy with 2:4 hardware speedup 鈥?currently the Pareto frontier on Ampere/Hopper Tensor Cores and our CPU 2:4 kernel.
...
```
鈹屸攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?    stage 1: MOT-FD distill   鈹屸攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?鈹?Qwen2.5-14B-Inst.  鈹? 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈻? 鈹?  Qwen2.5-3B       鈹?鈹? (teacher, frozen) 鈹?  48鈫?2 groups, OT align,     鈹? (student, FP16)   鈹?鈹?                   鈹?  monotonic constraint         鈹?                   鈹?鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?                              鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?                                                               鈹?                                              stage 2: SparseGPT prune
                                                               鈹?                                            鈹屸攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈻尖攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?                                            鈹? 3B @ 50% unstructured        鈹?                                            鈹?  + mask-preserving FT        鈹?                                            鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?                                                               鈹?                                       stage 3: INT8 QAT + QAD
                                       (re-using the 14B teacher)
                                                               鈹?                                            鈹屸攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈻尖攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?                                            鈹?3B INT8 (W8A8 + KV-cache)    鈹?                                            鈹?  safetensors / ONNX         鈹?                                            鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹?```

## Algorithm: MOT-FD

### 1. Teacher Functional Decomposition (48 鈫?12 Groups)
...
```
E(l) = 伪路||z_{l+1} - z_l|| + 尾路||z_{l+1} - 2z_l + z_{l-1}|| + 纬路(1 - cos(z_{l+1}, z_l))
```
...
**Interpretation:**
- Early groups 鈫?syntax / token formation
- Middle groups 鈫?semantic integration
- Late groups 鈫?reasoning + alignment

### 2. Student Representation Manifold

The student produces 36 layer hidden states H^S = {h_1^S, ..., h_36^S}. No explicit grouping is imposed 鈥?the student remains a continuous representation manifold.

### 3. Optimal Transport Alignment

A cost matrix C_{l,k} = ||h_l^S - g_k^T||^2 is built between all student layers and teacher group representations. The Sinkhorn algorithm solves for an entropy-regularized transport plan 纬* that minimizes 危 纬_{l,k} C_{l,k} subject to marginal constraints.

A **monotonic constraint** ensures semantic order is preserved: l_1 < l_2 鈬?E_纬[k|l_1] 鈮?E_纬[k|l_2]. This prevents "semantic backtracking" in student depth.

### 4. Composite Loss

```
L = L_CE + 位_KD路L_KD + 位_OT路L_OT + 位_mono路L_mono
```

- **L_CE**: Standard next-token prediction cross-entropy.
- **L_KD**: KL-divergence between student and teacher logits.
- **L_OT**: 危 纬_{l,k} C_{l,k} 鈥?the optimal transport alignment cost.
- **L_mono**: 危_l max(0, 渭_l - 渭_{l+1}) 鈥?monotonic regularization where 渭_l is the expected functional position of student layer l.
...
Requires Python 鈮?3.9, PyTorch 鈮?2.1, CUDA 鈮?11.8 (for flash-attention 2 you'll also want CUDA 12.x).
...
## Sparsity Strategies: Unstructured 鈫?Permuted 2:4

The pruning stage exposes three sparsity patterns, each at a different point on the accuracy/speed Pareto frontier.

| Pattern | 螖 PPL (3B) | Hardware acceleration | When to use |
|---|---:|---|---|
| Unstructured 50%      | ~0.4 | None (storage only)                          | Memory-constrained, no sparse hardware |
| Na茂ve 2:4             | 1.0 鈥?1.5 | cuSPARSELt (~1.5脳) Ampere/Hopper, custom CPU | 2:4 hardware available, accuracy hit OK |
| **Permuted 2:4** 猸?   | ~0.6 | Same as na茂ve 2:4                            | **Best of both worlds 鈥?current Pareto frontier** |

### Why na茂ve 2:4 hurts

A `2:4` constraint says: *every 4 consecutive columns must contain exactly 2 zeros*. This is a strong **positional** constraint 鈥?it doesn't care which 2 values are largest, only that they land in the right slots. When forced onto a weight matrix whose natural sparsity pattern is misaligned, it ends up zeroing values that should have been kept (and keeping values that should have been zeroed). Empirically, this costs ~1.0 PPL on Qwen2.5-3B vs. a 50% unstructured mask of the same row.
...
y = W P P鈦宦?x  =  W' x'       (P is any permutation matrix on `in`)

where  W' = W P    and    x' = P鈦宦?x
```
...
```
  hidden 鈹€鈹€鈻?gate_proj 鈹€鈹€鈹?                          鈹溾攢鈹€鈻?SwiGLU 鈹€鈹€鈻?down_proj 鈹€鈹€鈻?hidden
  hidden 鈹€鈹€鈻?up_proj   鈹€鈹€鈹?```

Permuting the `intermediate` dimension is network-equivariant if we permute, by the same `蟺`:

- the **rows** of `gate_proj.weight` and `up_proj.weight`, AND
- the **columns** of `down_proj.weight`

The block computes the *same function* 鈥?only the internal channel ordering changes. This is implemented in `apply_intermediate_permutation()` in `src/qwen_compress/prune/permutation.py`.
...
1. **Step 1 鈥?Unstructured SparseGPT.** Run pruning with `sparsity_type: unstructured` to get the max-quality 50% mask. This sets the accuracy ceiling.

2. **Step 2 鈥?Greedy column-swap search.** For each decoder block, find the permutation `蟺` of the `intermediate` axis that pushes as many existing zeros as possible into 2:4-aligned positions. The search is implemented in `PermutationSearcher`:
   - **Cost function:** count of (row 脳 group) pairs that don't yet have exactly 2 zeros out of 4 (the residual misalignment).
   - **Sampling:** swap candidates are biased toward groups with high misalignment (avoid wasting steps on already-aligned groups).
   - **Acceptance:** greedy 鈥?only swaps that strictly decrease cost are kept.
   - **Cost:** typically 0.1 鈥?2 seconds per layer on a single CPU thread.

3. **Step 3 鈥?Apply the permutation.** Permute `gate_proj` / `up_proj` rows and `down_proj` columns by the same `蟺`. Verify network equivalence: output of a random forward pass before/after should match to within FP16 ULP.

4. **Step 4 鈥?Hard-enforce 2:4.** Whatever misalignment is left after the search gets cleaned up by `hard_enforce_n_m()`: in each group of 4 columns per row, zero the 2 smallest-`|W|` entries. Typical cleanup touches < 5% of weights (vs. ~50% if you'd skipped step 2).

5. **Step 5 鈥?Recovery fine-tune.** Short mask-frozen fine-tune on the calibration data to recover the small accuracy loss introduced by step 4. (Stage 3 QAT will also run with mask preservation, so the zeros stay zero through training.)

### When this is worth running

- 鉁?Target hardware has 2:4 acceleration: NVIDIA Ampere/Hopper Tensor Cores via `cuSPARSELt`, or the [llama.cpp sparse 2:4 CPU kernel](https://github.com/eating-and-drinking/llama.cpp) shipped as a sister repository.
- 鉁?You want the accuracy of unstructured pruning *and* the speedup of 2:4.
- 鉂?Skip if you don't have 2:4 hardware 鈥?plain unstructured is simpler and at least as accurate.
- 鉂?Skip for tiny calibration sets (< 64 samples); SparseGPT itself may not converge well, so permutation buys you nothing.
...
print(f"alignment: {stats['avg_initial_alignment']:.1%} "
      f"鈫?{stats['avg_post_perm_alignment']:.1%} "
      f"鈫?100% after enforce")
```
...
Channel permutation for 2:4 alignment across 36 blocks (enforce=True)
  layer  0: alignment 49.8% 鈫?96.4% (misalign 102341 鈫?7912 鈫?0 after enforce)
  layer  1: alignment 49.7% 鈫?96.1% (misalign 103014 鈫?8154 鈫?0 after enforce)
  layer  2: alignment 49.9% 鈫?96.7% (misalign 101803 鈫?7521 鈫?0 after enforce)
  ...
```
...
| `ot_temperature` | Sinkhorn entropy regularization 蔚 | `0.1` |
| `sinkhorn_iters` | Sinkhorn iterations per step | `50` |
| `projector_lr_multiplier` | Projector LR = base LR 脳 this value | `0.1` |
...
The numbers below are illustrative defaults for `Qwen2.5-14B-Instruct 鈫?Qwen2.5-3B 鈫?INT8` on a CoT SFT corpus of 120K examples. Reproduce by running the full pipeline; your own results depend on data, hardware, and budget.

| Stage | Model size | Accuracy | Latency (A10, batch=1) |
|---|---:|---:|---:|
| Teacher (14B FP16) | 28 GB | 78.5 | 1.00脳 |
| MOT-FD distilled (3B FP16) | 6.2 GB | 72.0 | 0.32脳 |
| Pruned (3B 50%) | 6.2 GB 鈦?| 71.2 | 0.32脳 |
| Pruned + QAT INT8 | 2.4 GB | 70.5 | 0.21脳 |

鈦?Wall-clock size before sparse-aware packing; INT8 figure includes runtime quantization metadata.

## Project Layout

```
qwen-compress/
鈹溾攢鈹€ src/qwen_compress/
鈹?  鈹溾攢鈹€ distill/              # Stage 1: MOT-FD distillation
鈹?  鈹?  鈹溾攢鈹€ groupwise.py         # Teacher functional decomposition (48鈫?2 groups)
鈹?  鈹?  鈹溾攢鈹€ losses.py            # CE + KD + OT alignment + monotonic loss
鈹?  鈹?  鈹斺攢鈹€ trainer.py           # GroupwiseDistillTrainer
鈹?  鈹溾攢鈹€ prune/                # Stage 2: SparseGPT
鈹?  鈹?  鈹溾攢鈹€ sparsegpt.py         # Block-by-block one-shot pruner
鈹?  鈹?  鈹溾攢鈹€ permutation.py       # Channel permutation for 2:4
鈹?  鈹?  鈹溾攢鈹€ recovery.py          # Mask-preserving FT
鈹?  鈹?  鈹斺攢鈹€ utils.py             # N:M masks, sparsity metrics
鈹?  鈹溾攢鈹€ qat/                  # Stage 3: QAT + QAD
鈹?  鈹?  鈹溾攢鈹€ fake_quant.py        # FakeQuantize + QuantizedLinear
鈹?  鈹?  鈹溾攢鈹€ calibration.py       # Activation calibration
鈹?  鈹?  鈹溾攢鈹€ qad_trainer.py       # QAT loop with optional teacher
鈹?  鈹?  鈹斺攢鈹€ export.py            # safetensors / ONNX QDQ export
鈹?  鈹溾攢鈹€ models/qwen_wrapper.py
鈹?  鈹溾攢鈹€ data/{cot_dataset,calibration_data}.py
鈹?  鈹溾攢鈹€ utils/{config,checkpoint,logging,dist,seed}.py
鈹?  鈹斺攢鈹€ cli.py
鈹溾攢鈹€ configs/{distill,prune,qat,pipeline}/*.yaml
鈹溾攢鈹€ scripts/run_{distill,prune,qat,pipeline}.sh
鈹溾攢鈹€ examples/quick_start.py
鈹斺攢鈹€ tests/
```
...
Apache License 2.0 鈥?see [LICENSE](LICENSE). Includes an express patent grant.
